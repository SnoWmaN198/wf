...
class DefaultExtractor implements ExtractorInterface
{
     ...
     * Extract
     *
     * Extract the value of the given element. Throw RuntimeException
     * if parameter is not of the expected instance.
     *
     * @param mixed $element The element from where to extract the value
     *
     * @return string
     ...
     * Extract list
     *
     * Extract a list of values from a list of elements. Throw a RuntimeException if one of the given elements is not of the expected instance.
     *
     *  @param array $elements The list of elements from where to extract the values.
     *
     *  @return array
     *  @throws \RuntimeException
     */
